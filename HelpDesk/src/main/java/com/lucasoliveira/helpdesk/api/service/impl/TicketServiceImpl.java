...
import com.lucasoliveira.helpdesk.api.repository.ChangeStatusRepository;
import com.lucasoliveira.helpdesk.api.repository.TicketRepository;
...
public class TicketServiceImpl implements TicketService{
	...
	public Page<Ticket> findByParametersAndCurrentUser(int page, int count, String title, String status,
		...
		Pageable pages = new PageRequest(page, count);	
		return this.
				ticketRepository.findByTitleIgnoreCaseContainingAndStatusAndPriorityAndUserIdOrderByDateDesc(title, status, priority,userId, pages);
	}
